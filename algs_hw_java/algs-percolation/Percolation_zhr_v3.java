...
public class Percolation_zhr_v3 implements Percolation {
    ...
    public void open(int i, int j) {
        ...
        if(i == 1){
            ...
            puf2.union(p, n*n); // connect to virtual top
        }
        if(i == n){
            puf.union(p, n*n+1); // connect to virtual bottom difference no virtual bottom
        }
    }
    ...
    public boolean isFull(int i, int j) {
        int p = xy2index(i,j);
        boolean isconnected = puf2.connected(n*n, p);
