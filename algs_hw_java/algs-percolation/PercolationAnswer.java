...
public class PercolationAnswer implements Percolation
{
   ...
   public PercolationAnswer(int N) {
   ...
   public int getfindCount() {
       return grid.getfindCount() + auxGrid.getfindCount();
   }
    public int getUnionCount() {
         return grid.getUnionCount() + auxGrid.getUnionCount();
    }
